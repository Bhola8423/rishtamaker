  ...
  return (
    <footer className="relative mt-12 overflow-hidden bg-[#2a050c] text-slate-300 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-12 lg:px-8">
            ...
            <div className="flex items-center space-x-4 mt-2">
              {siteContent.socialMedia.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="text-slate-500 hover:text-[#D7A347] transition-colors"
                  target="_blank"
        ...
        {/* Popular Searches / Keyword Section for SEO */}
        <div className="border-t border-slate-800 mt-12 pt-8">
          <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 mb-6 text-center lg:text-left">Popular Matrimonial Searches</h3>

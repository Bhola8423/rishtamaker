    ...
    <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-white overflow-hidden">
      ...
      <div className="relative flex flex-col items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-4 text-center">
          <div className="relative h-10 w-48 transition-all duration-700">
             <Image 
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm font-semibold tracking-[0.3em] text-slate-400 uppercase animate-text-shimmer bg-gradient-to-r from-slate-400 via-[#b11e24]/40 to-slate-400 bg-[length:200%_auto] bg-clip-text text-transparent">
              Creating Memories
            </p>
          </div>
        </div>
